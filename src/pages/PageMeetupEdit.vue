          ...
          <div class="column is-3">
            <aside class="is-medium menu">
                ...
                <div class="meetup-side-box-date m-b-sm">
                  ...
                  <datepicker
                    ...
                    <vue-timepicker v-model="meetup.timeFrom"
                                    ...
                                    :minute-interval="5"></vue-timepicker>
                  </div>
                  <div class="field">
                    <!-- TODO: Implement @change Event -->
              ...
              <div class="meetup-side-box-map">
                <img src="https://png.pngtree.com/png-vector/20190115/ourlarge/pngtree-pin-map-graphic-icon-design-template-png-image_316195.jpg" class="venueMap-mapImg span--100" alt="Location image of meetup venue">
              </div>
            </aside>
          </div>
    ...
    methods: {
      ...
      updateMeetupHandler () {
        this.updateMeetup(this.meetup)
          .then(() => {
            this.$toasted.success('Meetup Succesfully Updated!', {duration: 3000})
          })
          .catch(err => console.log(err))
      },
      parseTime (time) {
